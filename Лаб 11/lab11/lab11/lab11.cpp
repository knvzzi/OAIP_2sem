...
int check_right(Tree* tree) //количества вершин дерева, являющихся правыми дочерними вершинами
{
	static int sum = 0;
	if (tree->Right != NULL)
	{
...
void main()
{
	...
	for (;;)
	{
		...
		cout << "11 -	вывод количества вершин дерева, являющихся правыми дочерними вершинами \n";
		...
		case 9: { static int k = 0;
			...
			cout << "Количество левых дочерних вершин = " << g - k << endl;
			k = g;
			break;
		}
		case 10: {
		...
		case 11: { static int k = 0;
			int g = check_right(Root);
			cout << "Количество правых дочерних вершин = " << g - k << endl;
			k = g;
			break;
		}
		case 12: { 
			cout << "Количество правых дочерних вершин = " << countEvenKeys(Root) << endl;
			break;
		}
		}
	}
